...
try:
    from shared.data_processing.decoder import find_annotation, decode_annotation, get_annotation_color
    ...
    sys.path.insert(0, str(shared_dir / 'data_processing'))
    ...
    from annotation_drawer import visualize_annotations
